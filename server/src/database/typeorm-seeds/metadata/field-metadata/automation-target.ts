...
export enum SeedAutomationTargetFieldMetadataIds {
  ...
  Author = '20202020-1e69-46ed-8015-c02ce2dfb7a1',
  AuthorForeignKey = '20202020-ff5d-48a2-8c89-8b206793900d',
...
export const seedAutomationTargetFieldMetadata = async (
  ...
  await workspaceDataSource
    ...
    .values([
      ...
      {
        id: SeedAutomationTargetFieldMetadataIds.Author,
        objectMetadataId: SeedObjectMetadataIds.AutomationTarget,
        isCustom: false,
        workspaceId: SeedWorkspaceId,
        isActive: true,
        ...
        label: 'Author',
        targetColumnMap: {},
        description: 'AutomationTarget author',
        icon: 'IconUser',
        isNullable: true,
        isSystem: false,
        defaultValue: undefined,
      ...
      {
        id: SeedAutomationTargetFieldMetadataIds.AuthorForeignKey,
        objectMetadataId: SeedObjectMetadataIds.AutomationTarget,
        isCustom: false,
        workspaceId: SeedWorkspaceId,
        isActive: true,
